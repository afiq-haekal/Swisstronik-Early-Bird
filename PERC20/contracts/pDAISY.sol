 ...
 */
contract pDAISY is PERC20 {
    constructor() PERC20("Private DAISY", "pDSY") {}
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        require(msg.sender == account, "pDAISY: msg.sender != account");
    ...
    function allowance(address owner, address spender) public view virtual override returns (uint256) {
        ...
        // extract original sender of this request. In case of regular (non-signed) `eth_call`
        // msg.sender will be empty address (0x0000000000000000000000000000000000000000)
        require(msg.sender == spender, "pDAISY: msg.sender != account");
